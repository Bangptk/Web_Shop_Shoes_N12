...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // 1. TÍNH TỔNG SỐ LƯỢNG <--- THÊM Ở ĐÂY
    const totalQuantity = displayItems.reduce((sum, item) => sum + parseInt(item.quantity), 0);
    ...
    const orderData = {
      ...
      quantity: totalQuantity, // 2. ĐƯA VÀO DATA GỬI ĐI <--- THÊM Ở ĐÂY
